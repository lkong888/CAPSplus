...
rule meth_sta_fastp_ncnn:
    ...
    shell: 
        """
            ...
            echo -e "smp\\tntrim_mCG_144hmC\\tntrim_nCG_144hmC\\tntrim_mCAA_144hmC\\tntrim_nCAA_144hmC\\tntrim_mnonCG_2kb\\tntrim_nnonCG_2kb\\tntrim_mnonCH_2kb\\tntrim_nnonCH_2kb\\tntrim_mnonC_2kb\\tntrim_nnonC_2kb\\tntrim_mCG_lambda\\tntrim_nCG_lambda\\tntrim_mCH_lambda\\tntrim_nCH_lambda" >{output.sta}
            echo -e "{output.sta}\\t${{ntrim_mCG_144hmC}}\\t${{ntrim_nCG_144hmC}}\\t${{ntrim_mCAA_144hmC}}\\t${{ntrim_nCAA_144hmC}}\\t${{ntrim_mnonCG_2kb}}\\t${{ntrim_nnonCG_2kb}}\\t${{ntrim_mnonCH_2kb}}\\t${{ntrim_nnonCH_2kb}}\\t${{ntrim_mnonC_2kb}}\\t${{ntrim_nnonC_2kb}}\\t${{ntrim_mCG_lambda}}\\t${{ntrim_nCG_lambda}}\\t${{ntrim_mCH_lambda}}\\t${{ntrim_nCH_lambda}}"  >>{output.sta}
        """
